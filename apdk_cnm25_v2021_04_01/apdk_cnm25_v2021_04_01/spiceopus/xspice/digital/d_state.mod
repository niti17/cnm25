...

{
    ...
    ret_str = (char *) tmalloc(strlen(buf) + 1);
...
void cm_d_state(ARGS) 
{
    ...
    if(INIT) {  /* initial pass */ 
        ...
        states->state = (int *) tmalloc((states->depth + 1)*sizeof(int));
        states->bits = (short *) tmalloc((states->num_outputs * states->depth / 4 + 1)*sizeof(short));
        states->inputs = (short *) tmalloc((states->num_inputs * states->depth / 8 + 1)*sizeof(short));
        states->next_state = (int *) tmalloc((states->depth + 1)*sizeof(int));
